...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  eyebrow: 'como é a sua jornada comigo',
  heading: 'Três passos para começar',
  steps: [
    {
      title: 'Você preenche e me chama no WhatsApp',
      body: 'Você responde 5 perguntas rápidas no formulário e me manda mensagem. Eu mesma respondo. Sem secretária, sem robô.',
    },
    {
      title: 'A primeira sessão acontece',
      body: 'Online de qualquer lugar do Brasil ou presencial em Siderópolis SC. Na primeira conversa eu investigo sua história e a gente já começa a olhar pra raiz.',
    },
    {
      title: 'A gente decide o caminho juntas',
      body: 'Algumas pessoas resolvem em poucas sessões. Outras precisam de um processo mais longo. Não existe protocolo igual. Cada raiz tem seu tempo. Eu te conduzo, você se entrega, a cura acontece de corpo e mente.',
    },
  ],
  note: 'Não tem cobrança. Não tem pressão. É uma conversa pra entender o seu caso e ver se faz sentido seguirmos juntas.',
