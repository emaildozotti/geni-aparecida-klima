...
const COPY = {
  ...
  heading: 'Se o que você leu aqui fez sentido,',
  headingEm: 'talvez seja hora de olhar pra raiz.',
  subtitle: 'A primeira sessão é uma conversa. Sem cobrança, sem pressão. Você me conta, eu escuto, a gente vê se faz sentido seguirmos juntas.',
  ctaText: 'Agendar minha sessão com Geni',
}
// ════════════════════════════════════════════════════════════════════
