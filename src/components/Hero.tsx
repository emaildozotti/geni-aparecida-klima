...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'DOR QUE NÃO PASSA',
  h1: 'A dor que volta toda semana não está no corpo,',
  h1Em: 'está na raiz.',
  subtitle: 'Eu atendo mulheres com dor física crônica que já tentaram médico, exame e terapia sem chegar na causa. Eu também já estive aí.',
  ctaPrimary: 'Quero agendar minha sessão',
  ctaSecondary: 'entender o método antes',
}
// ════════════════════════════════════════════════════════════════════
