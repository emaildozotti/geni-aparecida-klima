...
const COPY = {
  ...
  headingEm: 'eu quero te falar uma coisa.',
  preText: 'Esse vídeo é eu olhando no olho de quem está aí cansada de tentar.',
  postText: 'Se isso ressoou em você, segue comigo.',
}
